<template>
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <div>
        <el-form-item label="答案" prop="correctOptionKey">
          <el-input @focus="openCorrectOptionKeyDialog = true" type="textarea" v-model="form.correctOptionKey"></el-input>
        </el-form-item>
      </div>
    ...
    <el-dialog
      title=""
      :visible.sync="openCorrectOptionKeyDialog"
      width="80%"
      center
    >
      <tinymce v-model="form.correctOptionKey" :height="300" placeholder="请输入答案"/>
      <span slot="footer" class="dialog-footer">
      <el-button @click="openCorrectOptionKeyDialog = false">取 消</el-button>
      <el-button type="primary" @click="openCorrectOptionKeyDialog = false">确 定</el-button>
    </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      openCorrectOptionKeyDialog: false,
    }
  },
  created() {
    this.getClassList();
