    ...
    <el-row :gutter="20">
      ...
      <el-col :span="30" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="年级" align="center" key="gradeClassName" prop="gradeClassName" :show-overflow-tooltip="true" />
          <el-table-column label="手机号码" align="center" key="phonenumber" prop="phonenumber" v-if="columns[4].visible" width="120" />
          <el-table-column label="年龄" align="center" key="age" prop="age"/>
          <el-table-column label="出生日期" align="center" key="birthDate" prop="birthDate"/>
